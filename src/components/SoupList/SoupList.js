...
export default function SoupList(props) {
  return (
    <React.Fragment>
      <styled.Container>
        <styled.ImgWrapper>
          <styled.Image src={props.product.image}></styled.Image>
        </styled.ImgWrapper>
        <styled.Wrapper>
          <styled.SoupType>{props.product.category}</styled.SoupType>

          <styled.SoupTitle>{props.product.title}</styled.SoupTitle>
          ...
          <styled.IngrediensWrapper>
            <styled.Ingrediens>{props.product.ing1}</styled.Ingrediens>
            <styled.Ingrediens>{props.product.ing2}</styled.Ingrediens>
            <styled.Ingrediens>{props.product.ing3}</styled.Ingrediens>
            <styled.Ingrediens>{props.product.ing4}</styled.Ingrediens>
          </styled.IngrediensWrapper>
        </styled.Wrapper>
      </styled.Container>
    </React.Fragment>
